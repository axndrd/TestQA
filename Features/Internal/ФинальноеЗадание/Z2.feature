...
Сценарий: Проверка отчёта "Остатки товаров" на движения прихода/расхода, и Итога по разным складам.
	...
	*Проверка отчёта
	...
	И я жду, что в табличном документе "Результат" ячейка "R4C2" станет равна "$Склад1$" в течение 5 секунд
	И я жду, что в табличном документе "Результат" ячейка "R4C3" станет равна "$Склад2$" в течение 5 секунд
